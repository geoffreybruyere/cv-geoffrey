...
const S = StyleSheet.create({
  ...
  badge: { backgroundColor: '#FEFE7D', color: '#484800', fontSize: 6, fontWeight: 600, letterSpacing: 0.8, paddingVertical: 2, paddingHorizontal: 7, borderRadius: 20 },
  ...
  colLeft: { width: '58%' },
  colRight: { width: '42%' },
  sectionTitle: { fontSize: 6, fontWeight: 600, letterSpacing: 1.2, textTransform: 'uppercase', color: '#CACAC8', marginBottom: 5, marginTop: 10, paddingBottom: 3, borderBottomWidth: 0.5, borderBottomColor: '#EEEEE8', borderBottomStyle: 'solid' },
  ...
  e(Page, { size: 'A4', style: S.page },
    ...
    e(View, { style: S.header },
      ...
      e(View, { style: S.headerRight },
        e(Text, { style: S.badge }, '● DISPONIBLE'),
      ...
      e(View, { style: S.colLeft },
        ...
        e(View, { style: S.expItem },
          ...
          e(View, { style: S.expBullets },
            ...
            e(View, { style: S.expBullet }, e(Text, { style: S.expBulletDot }, '-'), e(Text, { style: S.expBulletText }, e(Text, { style: S.expBulletLabel }, 'Transfo IA '), 'Réduction >50% coûts SEO, renégociation >25% SaaS.')),
          ),
        ),
        // BonneGueule
        e(View, { style: S.expItem },
          ...
          e(View, { style: S.expBullets },
            e(View, { style: S.expBullet }, e(Text, { style: S.expBulletDot }, '-'), e(Text, { style: S.expBulletText }, e(Text, { style: S.expBulletLabel }, 'Marque '), 'Aucun discount en 12 ans. NPS 95. 63% repeat. 4,5M V.U./an.')),
            e(View, { style: S.expBullet }, e(Text, { style: S.expBulletDot }, '-'), e(Text, { style: S.expBulletText }, e(Text, { style: S.expBulletLabel }, 'Leadership '), '1 → 60 collaborateurs. Top 100 GPtW France. 7,7M€ levés.')),
          ),
        ),
        // Wavestone
        e(View, { style: S.expItem },
